...
- [Ninth/Columbus retail comparisons](nyc-pbl-retail-comparisons.md): two-year sales growth exceeded named corridors,
  as repeated in 2014 from a 2013 report; distinct from the 2012 headline, not independent confirmation.

- [Indianapolis Cultural Trail values](indianapolis-cultural-trail-property-values.md): ULI's reported 148% aggregate
  parcel appreciation, with an unclear window and no isolated trail premium.
- [Radnor Trail values](radnor-trail-property-values.md): reported $69,139 near-versus-far difference, not a measured
  post-construction gain.
