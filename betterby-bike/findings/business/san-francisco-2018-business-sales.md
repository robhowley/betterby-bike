---
type: Finding
title: San Francisco bike-lane sales results differed by customer base and district
description: Business Insider reports mixed 2018 San Francisco findings, including stronger local-serving performance in two districts and a sales-per-employee decline in another.
tags: [business, San Francisco, retail sales, secondary reporting]
sources:
  - id: rogers2024
...
uncertainty or sufficiently detailed comparison method. A local-versus-wider-market difference is not itself a
before/after lane effect, and sales per employee is not total sales or profits. The primary study was not reviewed.

## Related

- [San Francisco 2019 sales comparison](san-francisco-2019-business-sales.md): a later paper with street-treatment
  groups and median dollar changes; sample independence is not established by the article.
- [Evaluating street redesign outcomes](/topics/street-redesign-outcomes.md).

[^rogers2024]: Rogers (2024), PDF pp. 5–6, 2018 study account and Poirier interview.
